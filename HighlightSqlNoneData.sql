...
-- 傾印 hightlight 的資料庫結構
CREATE DATABASE IF NOT EXISTS `hightlight` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `hightlight`;

-- 傾印  資料表 hightlight.comment 結構
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户评论';
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `useremail` char(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '用户邮箱地址',
...
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户表';
...
CREATE TABLE IF NOT EXISTS `video` (
  ...
  `status` tinyint(1) NOT NULL COMMENT '0待审核，1审核通过，-1审核未通过',
  `checkresult` char(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '待审核' COMMENT '审核详情',
  PRIMARY KEY (`vid`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户上传的精彩集锦';
